<x-app-layout>
    ...
    <div class="bg-red-600 text-white py-10 shadow-md">
        <div class="max-w-7xl mx-auto px-4">
            <h1 class="text-3xl sm:text-4xl font-extrabold tracking-wide">Tambah Kategori</h1>
            <p class="text-red-100 mt-2 text-base sm:text-lg">
                Buat kategori baru untuk produk di MardikaStore
            </p>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto py-10 px-4">
        ...
        <div class="bg-white mt-8 p-6 sm:p-10 rounded-2xl shadow-md max-w-xl">
            ...
            <h2 class="text-xl font-bold text-gray-800 mb-6">Formulir Kategori</h2>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
                ...
                {{-- BUTTON --}}
                <button
                    class="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-xl shadow-md transition font-semibold">
                    Simpan Kategori
                </button>
